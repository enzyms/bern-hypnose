# Claude Code Configuration for Bern Hypnose

This project is a hypnotherapy practice website (bern-hypnose.ch) built with Astro 5, featuring comprehensive SEO setup, Google Business Profile automation, and structured data implementation.
...
- **Deployment**: Netlify
- **CMS**: Decap CMS
- **Styling**: Tailwind CSS + Svelte components
- **Domain**: https://bern-hypnose.ch
- **Language**: German (Switzerland)

## Key Directories

- `src/content/blog/` - 56 blog posts
- `src/content/faq/` - 15 FAQ items
- `src/schemas/` - Schema.org structured data
- `src/data/` - Site config, Google reviews, GBP queue
- `scripts/` - GBP publishing, review fetching automation

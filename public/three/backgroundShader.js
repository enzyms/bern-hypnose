...
const createBackgroundShaderMaterial = (THREE, width, height) => {
    const uniforms = {
        u_time: { value: 0.0 },
        u_resolution: { value: new THREE.Vector2(width, height) },
        u_color1: { value: new THREE.Color(0xf7e8b4) }, // Yellow color
        u_color2: { value: new THREE.Color(0xe9d7eb) } // Rose color
    };

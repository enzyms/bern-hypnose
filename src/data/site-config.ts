...
const siteConfig: SiteConfig = {
    ...
    hero: {
        ...
        name: 'Janine Aerni',
        text: "Ich bin Janine Aerni, diplomierte Hypnosetherapeutin in Bern. Mit einer warmen und unterstützenden Herangehensweise helfe ich dir durch Hypnosetherapie, Stress, Angst, Phobien und mehr zu überwinden. Entdecke die transformative Kraft der Hypnose in meiner Berner Praxis.",
        actions: [
            {
                text: 'Angebote',
                href: '/angebote'
    ...
    headerNavLinks: [
        ...
        },
        {
            ...
            subPagesTopics: [
                ...
                {
                    text: 'Stress mit Hypnose',
                    longText: 'Stress abbauen und gelassener werden',
                    href: '/hypnosetherapie/stress/',
                    diamondPosition: 2,
                    image: depressionImage,
                },
                {
                    text: 'Burnout mit Hypnose',
                    longText: 'Aus der Erschöpfung herausfinden',
                    href: '/hypnosetherapie/burnout/',
                    diamondPosition: 2,
                    image: depressionImage,
                },
                {
                    text: 'Depression mit Hypnose',
                    longText: 'Wieder Lebensfreude entwickeln',

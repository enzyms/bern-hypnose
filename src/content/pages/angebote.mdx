...
Du kannst mich einfach per E-Mail, SMS oder telefonisch kontaktieren, um **einen Gutschein** zu erhalten.
  ...
  <div class="w-1/2 sm:w-1/4 not-prose mt-2">
    <div class="w-36 h-36 shadow-sm shadow-yellow-200 -rotate-6 bg-yellow-100 text-red-600 rounded-full flex justify-center items-center aspect-square">
      <span class="text-base font-black leading-5 text-center">Verschenke<br />einen<br />Gutschein</span>
    </div>
  </div>
</div>
